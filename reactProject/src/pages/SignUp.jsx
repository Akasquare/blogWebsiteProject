 ...
 const navigate = useNavigate()
  ...
  return (
    ...
    <div className="flex items-center justify-center p-10 bg-zinc-100 h-[100vh]">
      ...
      <form className="rounded-xl bg-zinc-200 p-10" onSubmit={handleSubmit(getData)} action="">
        ...
        <input className="border border-purple-500 rounded-xl p-2"
          ...
          <div className="flex justify-center">
            <button className="bg-purple-400 hover:bg-purple-600 px-5 py-1 rounded-2xl text-white">Submit</button></div>
      </form>
      </div>
    </>
  );
